  ...
  const handleDelete = async () => {
    try {
        const response = await deleteApi(
            urls.Hearing.deletehearing.replace(":id", hearingToDelete)
        );
            ...
            <Grid item xs={12} >
              ...
              >
                <CardContent>
                  ...
                  <Divider
                    sx={{ mt: "10px", mb: "10px", borderColor: "grey.300" }}
                  />
                  <Grid item xs={12} >

                    <Box sx={{ overflow: "hidden", display: "flex", justifyContent: "space-between" }}>
                      <Typography variant="body1" fontWeight="bold">Judgement Reason </Typography>
                    </Box>
                  ...
                  <Grid item xs={12} >
                    <Box sx={{ overflow: "hidden", display: "flex", justifyContent: "space-between" }}>
                      <Typography mt={2} variant="body1" fontWeight="bold">Description</Typography>
                    </Box>
                    <Typography color="body2" sx={{ mt: 1 }}>
                      {rowData?.Description}
