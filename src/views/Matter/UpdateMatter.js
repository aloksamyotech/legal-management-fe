  ...
  const formik = useFormik({
        ...
        onSubmit: async (values) => {
          try {
            ...
            formik.resetForm();
            handleClose();
            toast.success(Messages.Matter.Matter_Update_sussess);
            fetchMatterData();
    
          } catch (error) {
            toast.error(Messages.Matter.Matter_Update_Failed);
          }
        },
      });
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <Typography style={{ fontWeight: 'normal' }} variant="h3">Update Matter</Typography>
          <Typography>
