...
//   const [finalPrompt, setPrompt] = useState(`${LAW_MANAGEMENT_CRM_CONTEXT}`);
    ...
    >
      ...
      >
        ...
        <InputAdornment position="end">
          ...
          <IconButton  color="black" onClick={handleSend} sx={{ background:"gray" ,'&:hover': {backgroundColor: "#673ab7", color:"white"}}}>
            <NorthIcon/>
          </IconButton>
        </InputAdornment>
      </Box>
